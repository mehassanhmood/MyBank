...
export const signUp = async ({password, ...userData}: SignUpParams) => {
  ...
  let newUserAccount;
    ...
    try {
        ...
        if(!newUserAccount) throw new Error("Error making new user");
        ...
        if (!dwollaCustomerUrl) throw new Error("Error making a dwolla customer url!");

        // extracting the dwolla customer id.
